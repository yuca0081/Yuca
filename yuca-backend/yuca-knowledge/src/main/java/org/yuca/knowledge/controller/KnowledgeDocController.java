...
import org.yuca.knowledge.service.KnowledgeDocService;
...
public class KnowledgeDocController {
    ...
    @RequireLogin
    public Result<List<KnowledgeChunk>> getChunks(
            @PathVariable Long docId) {
        Long userId = SecurityUtils.getCurrentUserId();
        List<KnowledgeChunk> chunks = knowledgeDocService.getChunks(docId, userId);
