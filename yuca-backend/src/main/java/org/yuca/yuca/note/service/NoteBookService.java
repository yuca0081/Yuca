...
import org.yuca.yuca.note.dto.request.CreateNoteBookRequest;
import org.yuca.yuca.note.dto.request.UpdateNoteBookRequest;
import org.yuca.yuca.note.dto.response.NoteBookResponse;
import org.yuca.yuca.note.entity.NoteBook;
import org.yuca.yuca.note.mapper.NoteBookMapper;
import org.yuca.yuca.note.util.NoteDataIntegrityUtils;
...
public class NoteBookService extends ServiceImpl<NoteBookMapper, NoteBook> {
    ...
    public void deleteNoteBook(Long bookId, Long userId) {
        ...
        // 检查笔记本是否有节点
        List<org.yuca.yuca.note.entity.NoteItem> items = dataIntegrityUtils.getItemsByBookId(bookId);
        if (!items.isEmpty()) {
            // 使用级联删除
